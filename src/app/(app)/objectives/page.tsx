...
export default async function ObjectivesPage({
  ...
  if (!can(user, "objectives", "VIEW")) return <AccessDenied label="الأهداف و KPI" />;
  const canEdit = can(user, "objectives", "EDIT");
    ...
    <div>
      ...
      {objectives.length === 0 ? (
        <EmptyState
          ...
          action={canEdit ? <ButtonLink href="/objectives/new">+ إضافة هدف</ButtonLink> : undefined}
        />
      ) : (
